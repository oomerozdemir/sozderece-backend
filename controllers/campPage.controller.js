...
const DEFAULT_CONTENT = {
  ...
  offer: {
    ...
    guarantees: ["7 gün koşulsuz iade", "Güvenli iletişim", "Derece koç desteği"],
  ...
  faq: {
    ...
    items: [
      ...
      { question: "Ücret iadesi mümkün mü?", answer: "Evet. İlk 7 gün içinde herhangi bir gerekçe bildirmeksizin koşulsuz iade hakkın var." },
